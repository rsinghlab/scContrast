...
if __name__ == "__main__":
    ...
    best_trial_results_checkpoints_path = f'best_trial_results/{VERSION}/checkpoints/multiseed_normalized'
    ...
    output_folder = f"figures/{VERSION}/multiseed_normalized/{experiment_name}_{augmentations_used_str}_epoch={saved_epoch}_final-loss={saved_loss:.4f}"
